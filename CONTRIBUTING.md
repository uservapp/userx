Contributing to UserX Core
============================

The UserX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the UserX Core project, and is not to be
confused with overall UserX Network Protocol consensus changes.

Whether a pull request is merged into UserX Core rests with the project merge
...
Patches that change UserX consensus rules are considerably more involved than
...
Where a patch set proposes to change the UserX consensus, it must have been
...
The project leader is the release manager for each UserX Core release.
