...
In order to support loading of multiple wallets in userx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is userx.cpp.
...
Changes to userx.cpp
----------------------
userx.cpp is the entry point into userx-qt, and as such, will require some minor modifications to provide hooks for
