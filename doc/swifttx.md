...
This mechanism has been integrated into Bitcore-Node-UserX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/uservapp/insight-api-userx#web-socket-api](https://github.com/uservapp/insight-api-userx#web-socket-api) 
* API: [https://github.com/uservapp/insight-api-userx#swifttx-transactions](https://github.com/uservapp/insight-api-userx#swifttx-transactions) 
...
By default, the UserX Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the UserX Core daemon:
