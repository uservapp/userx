...
#   c) node1 mines 32 blocks, so now node 0 has 60001userx, node 1 has 4250userx, node2 has none.
#   d) node0 sends 601 userx to node2, in two transactions (301 userx, then 300 userx).
