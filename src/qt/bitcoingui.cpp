                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("UserX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a UserX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and userx: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zUSERX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About UserX Core"), this);
    aboutAction->setStatusTip(tr("Show information about UserX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for UserX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your UserX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified UserX addresses"));
    ...
    openAction->setStatusTip(tr("Open a UserX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the UserX Core help message to get a list with possible UserX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("UserX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to UserX network", "", count));
}
...
{
    QString strTitle = tr("UserX Core"); // default title
