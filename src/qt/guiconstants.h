...
/* UserX GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "UserX"
#define QAPP_ORG_DOMAIN "userx.org"
#define QAPP_APP_NAME_DEFAULT "UserX-Qt"
#define QAPP_APP_NAME_TESTNET "UserX-Qt-testnet"
