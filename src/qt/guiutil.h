...
/** Utility functions used by the UserX Qt UI.
 */
namespace GUIUtil
{
...
// Render UserX addresses in monospace font
...
// Parse "userx:" URI into recipient object, return true on successful parsing
