...
public:
    ...
    void setZUserxControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzUSERX_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzUSERX_clicked();
    void on_pushButtonZUserxControl_clicked();
