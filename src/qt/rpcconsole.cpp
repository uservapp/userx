                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzUSERXPathCustom = GetArg("-zuserxbackuppath", "");
    ...
    if(!strzUSERXPathCustom.empty()) {
        ui->wallet_customzuserxbackuppath->setText(QString::fromStdString(strzUSERXPathCustom));
        ui->wallet_customzuserxbackuppath_label->setVisible(true);
        ui->wallet_customzuserxbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzUSERXPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the UserX RPC console.") + "<br>" +
