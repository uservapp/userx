 ...
 */
    ...
    typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakeZUSERX));
    typeWidget->addItem(tr("Masternode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::MNReward));
    // userx typeWidget->addItem(tr("Received USERX from zUSERX"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    // userx typeWidget->addItem(tr("Zerocoin Mint"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinMint));
    // userx typeWidget->addItem(tr("Zerocoin Spend"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend));
    // userx typeWidget->addItem(tr("Zerocoin Spend, Change in zUSERX"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zUserx));
    // userx typeWidget->addItem(tr("Zerocoin Spend to Self"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_FromMe));
