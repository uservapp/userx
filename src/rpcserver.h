...
// userx extern UniValue getzerocoinbalance(const UniValue& params, bool fHelp);
...
extern UniValue setzuserxseed(const UniValue& params, bool fHelp);
extern UniValue getzuserxseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzuserx(const UniValue& params, bool fHelp);
extern UniValue dzuserxstate(const UniValue& params, bool fHelp);
