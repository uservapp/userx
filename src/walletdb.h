...
public:
    ...
    bool WriteZUSERXSeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZUSERXSeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZUSERXSeed_deprecated(uint256& seed);
    bool EraseZUSERXSeed();
    bool EraseZUSERXSeed_deprecated();

    bool WriteZUSERXCount(const uint32_t& nCount);
    bool ReadZUSERXCount(uint32_t& nCount);
