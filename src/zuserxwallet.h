...
#ifndef USERX_ZUSERXWALLET_H
#define USERX_ZUSERXWALLET_H
...
public:
    CzUSERXWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZUSERX(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZUSERX(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //USERX_ZUSERXWALLET_H
